...
\name{Tino}{Rusch}
\address{Schierker Str. 7, 39118 Magdeburg, Germany}
\mobile{(+49) 151-140-22-752}
\email{tino.rusch@gmail.com}
\homepage{www.trusch.io}
\github{trusch}
%\skype{skypeid}
...
\position{Senior Software Engineer} % Your expertise/fields
\quote{``If we want, we can fully decentralise it.''} % A quote or statement

\makecvfooter{\today}{Tino Rusch~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
